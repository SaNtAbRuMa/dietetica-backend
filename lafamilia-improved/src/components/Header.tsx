...
import { ShoppingBag, Leaf, Search, ChevronDown } from 'lucide-react';
...
export function Header({ 
  ...
  // FIX: reemplazado group-hover por estado para que funcione en mobile/touch
        ...
        <div className="flex justify-between items-center h-16 gap-4">
          ...
          <div className="flex-1 max-w-md relative">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-white border border-stone-200 rounded-full text-sm focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all shadow-sm" 
            />
          </div>
